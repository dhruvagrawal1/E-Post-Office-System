...
class Signup:
    def __init__(self):
        root1 = Tk()
        root1.title("Signup")
        root1.geometry("750x550+300+100")
        root1.configure(background="cyan")
        label = Label(root1, text="Fill Your Details", font=("times new roman", 30, "bold"), bg="cyan",
                      fg="black")
        label.place(x=230, y=10)
        label1 = Label(root1, text="Name:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        label1.place(x=20, y=100)
        textbox1 = Entry(root1, width=25, font=("times new roman", 10, "bold"))
        textbox1.place(x=80, y=103)
        label2 = Label(root1, text="Email:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        label2.place(x=370, y=100)
        textbox2 = Entry(root1, width=25, font=("times new roman", 10, "bold"))
        textbox2.place(x=430, y=103)
        label3 = Label(root1, text="Phone Number:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        label3.place(x=20, y=170)
        textbox3 = Entry(root1, width=25, font=("times new roman", 10, "bold"))
        textbox3.place(x=150, y=176)
        username = StringVar()
        password = StringVar()
        label4 = Label(root1, text="Username:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        ...
        label5 = Label(root1, text="Password:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        ...
        label6 = Label(root1, text="Confirm Password:", font=("times new roman", 13, "bold"), bg="cyan",
                       fg="black")
        label6.place(x=320, y=240)
        textbox6 = Entry(root1, width=25, font=("times new roman", 10, "bold"), show="*")
        textbox6.place(x=475, y=245)
        label7 = Label(root1, text="Address:", font=("times new roman", 13, "bold"), bg="cyan", fg="black")
        ...
        def sign_up():
            try:
                ...
                data = (a, textbox1.get(), textbox2.get(), textbox3.get(), textbox4.get(), textbox5.get(),
                        textbox7.get())
                cur.execute(query, data)

                if textbox5.get() == textbox6.get() and textbox5.get() != "" and textbox6.get() != "" and textbox1.get() != "" and textbox2.get() != "" and textbox3.get() != "" and len(
                        textbox3.get()) <= 10 and textbox4.get() != "" and textbox7.get() != "":
        ...
        button1 = Button(root1, text="Signup", font=("times new roman", 15, "bold"), bg="white", fg="black",
                         command=sign_up)
        button1.place(x=200, y=450)
        button2 = Button(root1, text="Back", font=("times new roman", 15, "bold"), bg="white", fg="black",
                         command=back)
        button2.place(x=300, y=450)
        button3 = Button(root1, text="Cancel", font=("times new roman", 15, "bold"), bg="white", fg="black",
                         command=Quit)
